  ...
  <div class="number-report" @click="closeModal">
    ...
    <div v-if="hasItemsForCurrentTab && !loading && filtersExpanded" class="filters-container" @click="closeModal">
      ...
      <div class="search-filter-section">
        ...
        <div class="search-keywords-list" v-if="searchKeywords.length > 0">
          <div v-for="(keyword, index) in searchKeywords" :key="index" class="search-keyword">
            <span>{{ keyword }}</span>
            <svg
                @click="removeSearchKeyword(index)"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 384 512"
            >
      ...
      <div class="minus-keywords-section-all-tabs">
        <div class="minus-keywords-section">
          ...
          <div class="minus-keywords-list" v-if="minusKeywords.length > 0">
            <div v-for="(keyword, index) in minusKeywords" :key="index" class="minus-keyword">
              <span>{{ keyword }}</span>
              <svg
    ...
    <div class="content" @click="closeModal">
      ...
      <div
          ...
          style="overflow-x: scroll;min-height: calc(100vh - 103px);"
      >
        <div>
...
const filteredItems = computed((): Item[] => {
  ...
  // Apply search filter (positive keywords)
  ...
  // Apply minus keywords filter (negative keywords)
