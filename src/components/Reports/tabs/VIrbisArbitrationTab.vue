      ...
      <div class="filters-card">
        ...
        <div class="filters-grid">
          ...
          <div class="filter-group">
            ...
            <div class="role-hint">
              Оставьте пустым для поиска по всем ролям
            </div>
          </div>
        </div>
    ...
    <div v-else class="cases-list">
      ...
      >
        <div class="case-header" @click="toggleCaseDetails(arbitrationCase.id)">
          <div class="case-main-info">
            <div class="case-number">
              Дело № {{ arbitrationCase.case_number }}
            </div>
            <div class="case-court">
              {{ arbitrationCase.court_name }}
            </div>
            <div class="case-participant">
              {{ arbitrationCase.name }}
            </div>
          </div>

          <div class="case-meta">
            <div class="case-date">
              {{ formatDate(arbitrationCase.case_date) }}
            </div>
            <div class="case-role" v-if="arbitrationCase.role?.name">
              {{ arbitrationCase.role.name }}
            </div>
            <div class="case-type" v-if="arbitrationCase.case_type?.name">
              {{ arbitrationCase.case_type.name }}
            </div>
            <div class="search-type-badge">
              {{ getSearchTypeName(arbitrationCase.search_type) }}
            </div>
          </div>
        ...
        >
          ...
          <div v-else-if="detailsErrors[arbitrationCase.id]" class="details-error">
            <div class="error-icon">⚠️</div>
            <div class="error-message">{{ detailsErrors[arbitrationCase.id] }}</div>
            <button @click="retryFetchDetails(arbitrationCase.id)" class="retry-details-button">
              Повторить попытку
            </button>
          </div>

          <div v-else-if="caseDetails[arbitrationCase.id]" class="details-content">
            <div class="details-grid">
              <div class="detail-item">
                <span class="detail-label">Участник:</span>
                <span class="detail-value">{{ caseDetails[arbitrationCase.id].name || 'Не указан' }}</span>
              </div>

              <div class="detail-item">
                <span class="detail-label">Адрес:</span>
                <span class="detail-value">{{ caseDetails[arbitrationCase.id].address || 'Не указан' }}</span>
              </div>

              <div class="detail-item">
                <span class="detail-label">ИНН:</span>
                <span class="detail-value">{{ caseDetails[arbitrationCase.id].inn || 'Не указан' }}</span>
              </div>

              <div class="detail-item">
                <span class="detail-label">Регион:</span>
                <span class="detail-value">{{ caseDetails[arbitrationCase.id].region || 'Не указан' }}</span>
              </div>

              <div class="detail-item">
                <span class="detail-label">Тип дела:</span>
                <span class="detail-value">{{ caseDetails[arbitrationCase.id].case_type || 'Не указан' }}</span>
              </div>

              <div class="detail-item">
                <span class="detail-label">Роль:</span>
                <span class="detail-value">{{ caseDetails[arbitrationCase.id].role || 'Не указана' }}</span>
              </div>

              <div v-if="caseDetails[arbitrationCase.id].opponents?.length" class="detail-item full-width">
              ...
              <div v-else class="detail-item full-width">
                <span class="detail-label">Противоположные стороны:</span>
                <span class="detail-value">Не указаны</span>
              </div>
            </div>
          </div>
        </div>
