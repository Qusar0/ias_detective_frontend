<template>
    <div class="content">
        ...
        <div class="form" style="max-width: 700px;">
            <div style="font-size: 22px; font-weight: 600; line-height: 1; margin-bottom: 9px;font-size: 21px;">Написать нам
            </div>
            <div class="inputs flex-col" style="flex-direction: column;gap: 10px;">
                <div class="flex flex-col w-full parent-prompt top-input" style="border: none !important;">
                    <input v-model="form.theme" type="text" title="some title ..." placeholder="Контакт для связи"
                        style="margin-right: 0px;margin-bottom: 0px;border: none !important;font-size: 15px;"><small
                        class="prompt">Введите свой контакт для связи с тех под.</small>
                </div>
                <div class="flex flex-col w-full parent-prompt top-input"
                    style="margin-right: 20px; margin-bottom: 0px; align-items: start;"><input v-model="form.description"
                        type="text" placeholder="Тема сообщение"
                        style="margin-right: 0px;border: none !important;font-size: 15px;margin-bottom: 0px;"><small
                        class="prompt">Введите тему сообщение</small></div>
                <div class="flex flex-col w-full parent-prompt top-input" style="margin-bottom: 0px; align-items: start;">
            ...
            </div><button class="btn" @click="send_support()">Отправить</button>
        </div>
