  ...
  <div class="content">
    ...
    <div class="items">
      <div class="item" v-for="query in query_list" :key="query.query_id">
        ...
        <button v-else class="download item-btn btn" @click="downloadQuery(query.query_title, query.query_id, query)">
          Скачать <i class="fa-solid fa-spinner" v-show="query.downloading" style=""></i></button>
        <i
