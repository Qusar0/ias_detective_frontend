      ...
      <div class="items head-item">
        ...
        <div class="items">
            <div class="item" v-for="query in query_list" :key="query.query_id">
              ...
              <button v-else class="item__content item-btn btn" @click="downloadQuery(query.query_title, query.query_id, query)">Скачать <i class="fa-solid fa-spinner" v-show="query.downloading" style="margin-left: 5px;"></i></button>
              <i
